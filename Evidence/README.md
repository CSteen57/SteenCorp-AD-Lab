...
This directory contains screenshots validating each stage of the SteenCorp lab.

## Structure

- `Infrastructure`: AD setup, OU structure, RBAC, and file shares
- `Automation`: PowerShell infrastructure deployment, bulk provisioning, onboarding, and validation
